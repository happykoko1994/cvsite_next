const projectDetails = [
    {
        ...
        alt: 'shop',
        body: 'Сайт онлайн магазина на ReactJS, с возможностью регистрации новых пользователей, выбора категорий товаров и их сортировки, постраничный вывод товаров, а также карточками отдельных товаров. Реализована админ панель для добавления новых брендов, типов и девайсов. Был настроен локальный сервер PostgresQL для хранения данных и обмена ими с сайтов.',
    ...
    },
    {
        ...
        alt: 'convert',
        body: 'Приложение для конвертирования валют. Создано с помощью библиотеки React.',
